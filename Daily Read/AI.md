...
[Remember Vibe Coders? Yeah… They're Gone](https://freedium.cfd/https://medium.com/write-a-catalyst/remember-vibe-coders-yeah-theyre-gone-2a1c52eed4ff)

Vibe Coding，氛围变成，指将实现逻辑和底层细节完全交给 AI，只关注 AI 效果不关注实现原理。

AI 干活很快，但不注意质量和安全性，生成的代码难以维护。作为开发者要将 AI 视为工具，自己把握技术细节。文中有个比喻很好：We thought we were getting an autopilot. But the OGs are now telling us we just got a very, very fast junior intern, who will mess up big time.
