...
- [GitLab 文档：Keyword reference for the .gitlab-ci.yml file (FREE)](https://git.garena.com/help/ci/yaml/README)
...
[Keyword reference for the .gitlab-ci.yml file](https://git.garena.com/help/ci/yaml/README)
