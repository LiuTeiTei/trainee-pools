...
+ [[极客重学前端] JavaScript类型：关于类型，有哪些你不知道的细节？](https://b.geekbang.org/member/course/detail/78884) 
+ [[极客重学前端] JavaScript对象：你知道全部的对象分类吗？](https://b.geekbang.org/member/course/detail/80011) 
